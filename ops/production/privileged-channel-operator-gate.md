...
API/Web deploy/rollback and mail-network verification commands without another
privilege expansion. The existing `ASODEF_PHASE1_MAIL_MUTATION` channel and its
