...
function KnowledgeDetail({ detail, selectedVersion, selectedVersionId, onSelectVersion, actions, changeReason, onReason, onAction, pending, diff, diffPending, onLoadDiff, audit, canDiff }: { detail: import("./knowledge.types").KnowledgeItem | undefined; selectedVersion: KnowledgeVersion | null; selectedVersionId: string | null; onSelectVersion: (id: string) => void; actions: Array<{ action: LifecycleAction; label: string }>; changeReason: string; onReason: (value: string) => void; onAction: (action: LifecycleAction) => void; pending: boolean; diff: import("./knowledge.types").KnowledgeDiff | undefined; diffPending: boolean; onLoadDiff: () => void; audit: import("./knowledge.types").KnowledgeAuditEvent[]; canDiff: boolean }) {
