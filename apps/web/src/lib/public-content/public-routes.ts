...
export const PUBLIC_ROUTES = {
  ...
  faqs: { path: "/recursos/preguntas-frecuentes", label: "Preguntas frecuentes", description: "Respuestas verificables sobre los canales de la plataforma.", group: "resources", seo: { title: "Preguntas frecuentes | ASODEF", description: "Resuelve dudas sobre beneficios, pagos, portales, PQR, datos personales y canales de ASODEF." } },
