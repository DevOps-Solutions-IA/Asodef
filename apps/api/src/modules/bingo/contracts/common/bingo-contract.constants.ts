...
export const BINGO_FAIRNESS_MODES = [
  "CRYPTO_RNG",
  "CRYPTO_RNG_COMMIT_REVEAL",
] as const;
export const BINGO_WINNER_VISIBILITIES = [
  "CARD_ONLY",
  "PARTIAL_NAME_AND_CARD",
] as const;
...
export const BINGO_PARTICIPANT_KINDS = [
  "AFFILIATE",
  "BENEFICIARY",
...
export type BingoEventVisibilityContract =
  (typeof BINGO_EVENT_VISIBILITIES)[number];
export type BingoEligibilityPolicyContract =
  (typeof BINGO_ELIGIBILITY_POLICIES)[number];
export type BingoValidationPolicyContract =
  (typeof BINGO_VALIDATION_POLICIES)[number];
...
export type BingoWinnerVisibilityContract =
  (typeof BINGO_WINNER_VISIBILITIES)[number];
export type BingoPatternKindContract = (typeof BINGO_PATTERN_KINDS)[number];
export type BingoParticipantKindContract =
  (typeof BINGO_PARTICIPANT_KINDS)[number];
