...
/** Structural view of PR #19's append-only ConversationEvent. It is an
...
export const TOOL_EXECUTION_BOUNDARY = Object.freeze({
  version: CROSS_CONTRACT_RECONCILIATION_VERSION,
  requestContract: "PR20:ToolGatewayRequest@v1",
  trustedContextContract: "PR20:ToolInvocationContext",
  correlationId: "Inherited from trusted ToolInvocationContext",
  causationId:
    "Direct triggering DomainEvent.eventId, ConversationEvent.id or authorized command reference",
  idempotencyKey:
    "Required for mutations; derive a new operation-scoped key rather than reusing a DomainEvent key blindly",
  audit:
